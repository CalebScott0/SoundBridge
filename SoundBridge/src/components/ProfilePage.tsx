...
export function ProfilePage({ profile, onBack, onCollab }: ProfilePageProps) {
  return (
      ...
      <div className="flex flex-wrap items-start gap-6">
        ...
        <div className="flex-1 space-y-6">
          <div>
            ...
            <p className="mt-2 text-sm text-amber-200/80">{profile.bio}</p>
          </div>
            ...
            <div className="rounded-2xl border border-red-900/40 bg-black/40 p-4">
              ...
              <div className="mt-2 space-y-1 text-sm text-amber-200/80">
                ...
                {profile.socials.tiktok && (
                  <p>TikTok: {profile.socials.tiktok}</p>
                )}
                {profile.socials.twitter && (
                  <p>Twitter: {profile.socials.twitter}</p>
                )}
          ...
          <div className="rounded-2xl border border-red-900/40 bg-black/40 p-4">
            ...
            <p className="mt-2 text-sm text-amber-200/80">
              {profile.compatibility ?? "Compatibility insights coming soon."}
            </p>
          </div>
